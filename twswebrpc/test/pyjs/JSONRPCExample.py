...
class JSONRPCExample:
    ...
    def onModuleLoad(self):
        ...
        self.methods = [self.METHOD_ECHO, self.METHOD_REVERSE, 
                        ...
                        self.METHOD_ECHO_WITH_CLIENT_INFO,
...
""")
    ...
    def onClick(self, sender):
        ...
        if sender == self.button_py:
            ...
            elif method == self.METHOD_ECHO_WITH_CLIENT_INFO:
...
class EchoServicePython(JSONProxy):
    def __init__(self):
        JSONProxy.__init__(self, "test", ["echo", "reverse", "uppercase", "lowercase", "echo_client_info",
                                          "nonexistant"])
